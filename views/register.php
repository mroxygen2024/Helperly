<div class="card" style="margin-top: 2rem;">
    <div class="card-header flex-col items-start gap-2">
        <h2 class="card-title" style="font-size: 1.75rem;">Start Your Journey</h2>
    ...
    <form action="/register" method="POST" class="flex flex-col gap-4">
        ...
        <div class="form-group">
            ...
            <input id="name" name="name" type="text" class="input-field" value="<?= escape(old('name')); ?>" required placeholder="John Doe">
        </div>

        <div class="grid grid-cols-2 gap-4">
            <div class="form-group">
                <label for="email" class="label">Email Address</label>
                <input id="email" name="email" type="email" class="input-field" value="<?= escape(old('email')); ?>" required placeholder="john@example.com">
            </div>
            <div class="form-group">
                <label for="phone" class="label">Phone Number</label>
                <input id="phone" name="phone" type="tel" class="input-field" value="<?= escape(old('phone')); ?>" required placeholder="+1234567890">
            </div>
        </div>
        ...
        <p class="text-center text-sm text-muted mt-4">
            Already have an account? <a href="/login" style="color: var(--primary); font-weight: 700;">Sign in instead</a>
        </p>
    </form>
</div>
